...
const ProductsGrid = styled.div`
	/* fixed column width so gap between cards is constant */
	display: grid;
	/* increase to match larger card width */
	...
	@media (max-width: 768px) {
		...
		> div {
			padding: 12px; /* compact but readable on small screens */
		}
	}
`;
		...
		<PageWrapper>
			<Container>
				...
				{filteredAndSortedProducts.length > 0 ? (
					...
					<p style={{ textAlign: 'center', marginTop: '2rem' }}>No products match your criteria.</p>
				)}
			</Container>
		</PageWrapper>
	);
